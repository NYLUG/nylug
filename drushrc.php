...
$options['structure-tables'] = array(
 'common' => array('accesslog', 'cache', 'cache_admin_menu', 'cache_block', 'cache_bootstrap', 'cache_field', 'cache_filter', 'cache_form', 'cache_menu', 'cache_page', 'cache_path', 'cache_update', 'cache_views', 'cache_views_data', 'search_dataset', 'search_index', 'search_total', 'sessions', 'watchdog', 'history'),
);
